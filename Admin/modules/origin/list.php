...
<div class="list-origin">
	<a href="index.php?module=origin&action=insert"><h2><i style="color: gray;margin-right: 10px;" class='fa fa-plus-circle'></i>Thêm xuất xứ</h2></a>
	<table>
		<tr>
			<th>ID</th>
			<th>Xuất xứ</th>
		...
		if($result==false){
			...
			echo "<tr><th colspan='5'>Danh sách rỗng</th></tr>";
				...
				foreach ($result as $row) {
					...
					echo "<td>";
				     echo "<a href='index.php?module=origin&action=edit&id=$id'><i class='fa fa-edit'></i>Sửa</a>";
					echo "</td>";
					echo "<td>";
					echo "<a href='index.php?module=origin&action=delete&id=$id'><i class='fa fa-eraser'></i>Xóa</a>";
					echo "</td>";
					echo"</tr>";
				}
			}
...
<div style="height: 300px; border-bottom: 2px dotted gray;position: relative;top: 800px;">
