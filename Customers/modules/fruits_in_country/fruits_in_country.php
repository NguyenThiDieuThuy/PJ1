...
<?php
$sql= "SELECT id,name,url,price FROM products WHERE id_origin=30 " ;
...
<?php
$tittle="Hoa quả trong nước";
require_once("layout/header.php");
?>
<div class="list">
	<div style="background-color: lightgray;position: relative;top: 50px;width: 27%;font-size: 30px;height: 50px;">
	<p style="position: relative;top: 10px" ><a href="index.php?module=home&action=home">Trang chủ</a>//Hoa quả trong nước</p></div>
	<form method="GET">
		<input type="hidden" name="module" value="fruits_in_country">
		<input type="hidden" name="action" value="fruits_in_country">
	...
	<table>
     ...
     <a href="index.php?module=fruits_in_country&action=fruits_in_country&page=<?php echo ($page-1);?>" style=" margin-left: 650px; float: right;top: 100px; position: relative; right: 300px;">Previous</a>
     <span style="float: right; position: relative; left: 500px; top: 100px;"><?php echo " $page "; ?></span>
     
     <a href="index.php?module=fruits_in_country&action=fruits_in_country&page=<?php echo ($page+1);?>"style=" position: relative; left: 620px;  float: right; top: 100px;">Next</a>
	

	</div>
	<div style="height: 315px;border-top: 2px  gray dotted;position: relative;top: 250px;background-color:#92D918; ">
