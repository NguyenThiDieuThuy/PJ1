...
<div class="list">
	...
	<form method="GET">
		<input type="hidden" name="module" value="dried_fruits">
		<input type="hidden" name="action" value="dried_fruits">
     ...
     <a href="index.php?module=dried_fruits&action=dried_fruits&page=<?php echo ($page-1);?>" style=" margin-left: 650px; float: right;top: 100px; position: relative; right: 300px;">Previous</a>
     <span style="float: right; position: relative; left: 500px; top: 100px;"><?php echo " $page "; ?></span>
     
     <a href="index.php?module=dried_fruits&action=dried_fruits&page=<?php echo ($page+1);?>"style=" position: relative; left: 620px;  float: right; top: 100px;">Next</a>
	</div>
