<?php
$error="";
$sql= "SELECT id,name,url,price FROM products WHERE id_type = 3 ";
...
?>
<div class="list">
	<div style="background-color: lightgray;position: relative;top: 50px;width: 20%;font-size: 30px;height: 50px;">
	<p style="position: relative;top: 10px" ><a href="index.php?module=home&action=home">Trang chủ</a>//Hoa quả sấy</p></div>
	<form method="GET">
		<input type="hidden" name="module" value="fruits_basket">
		<input type="hidden" name="action" value="fruits_basket">
	...
	<a href="index.php?module=fruits_basket&action=fruits_basket&page=<?php echo ($page-1);?>" style=" margin-left: 650px; float: right;top: 100px; position: relative; right: 300px;">Previous</a>
     <span style="float: right; position: relative; left: 500px; top: 100px;"><?php echo " $page "; ?></span>
     
     <a href="index.php?module=fruits_basket&action=fruits_basket&page=<?php echo ($page+1);?>"style=" position: relative; left: 620px;  float: right; top: 100px;">Next</a>
